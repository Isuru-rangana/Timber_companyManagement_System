...
function SalesReport(){
    ...
    const fetchRecords = async () => {
      try {
        const response = await axios.get(`http://localhost:8070/sales/report/${year}/${month}`);
    ...
    const fetchTotal = async () => {
        try {
          const response = await axios.get(`http://localhost:8070/sales/sales/${year}/${month}`);
...
if(!buttonClicked){
    ...
    return (
      ...
      <div class="details" >
      <h3 id="monthReport"><b>Monthly Sales Report</b></h3>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <Link to="/getSales" className="reportBackBtn">
                Back
            </Link>
        </form>
  ...
  return (
      ...
      <h3 className="reportHead2">Monthly Sales Report - {year}/0{month}</h3>
          <table  id="myTable" >
              <thead>
              <tr >
                  <th>Order No</th>
